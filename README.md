...
<a href="">[![GitLab](https://img.shields.io/gitlab/v/release/Acclorite/book-story.svg?labelColor=27303D&color=773f9b&label=GitLab&logo=gitlab)](https://gitlab.com/Acclorite/book-story/-/releases)</a>
...
- _**Installing from GitHub**_: Click the "Get it on GitHub" badge above, scroll down, and download
  **book-story.apk**, or grab the latest APK
  directly [here](https://github.com/Acclorite/book-story/releases/latest/download/book-story.apk).
  Once downloaded, locate the APK file and install it.
- _**Installing from GitLab**_: Click the "Get it on GitLab" badge above, scroll down, and download
